...
CREATE TABLESPACE principaltbs DATAFILE 'principal.dbf' size 10M;
CREATE USER principal IDENTIFIED BY principal DEFAULT TABLESPACE principaltbs;
GRANT ALL PRIVILEGES TO principal;
...
sqlplus principal/principal
CREATE DIRECTORY equipos_export as 'c:/tmp/equipos/export/';
CREATE DIRECTORY ligas_export as 'c:/tmp/ligas/export/';

sqlplus system/admin
ALTER SESSION SET "_ORACLE_SCRIPT" = true;
CREATE USER equipos IDENTIFIED BY equipos;
GRANT ALL PRIVILEGES TO equipos;
CREATE DIRECTORY equipos_import as 'c:/tmp/equipos/import/';

sqlplus system/admin
ALTER SESSION SET "_ORACLE_SCRIPT" = true;
CREATE USER ligas IDENTIFIED BY ligas;
GRANT ALL PRIVILEGES TO ligas;
CREATE DIRECTORY ligas_import as 'c:/tmp/ligas/import/';
